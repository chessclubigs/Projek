...
class CreateTournamentForm(FlaskForm):
    ...
    participants = QuerySelectMultipleField("Participants", query_factory=lambda: Member.query.filter_by(is_active=True).order_by(Member.full_name).all(), allow_blank=True, get_label="full_name")
